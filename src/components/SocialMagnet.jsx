...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/shivam-kumar1214/', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/shivam121214', icon: ICONS.GitHub },
  { name: 'Mail', url: 'mailto:shivamlpu1214@gmail.com', icon: ICONS.Mail },
];
